...
html_dir = r'C:\Users\E40085777\flammability_project\templates'
...
def index():
  try:
    ...
    return render_template('index.html', table_html=table_html)  # Assuming render_template still works
